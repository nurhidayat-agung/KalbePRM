...
public class DownloadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnDownloadNoRealisasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<clsMobile_MBranch> ListOfMbranch = appDatabase.daoMobileMBranch().getAll();
    ...
    private void LoadDataNoRealisasi() {
        ...
        // List<clsMobile_ValidationNo> ListOfclsMobile_ValidationNoe = new Select()
        // .from(clsMobile_ValidationNo.class).execute();
        List<clsMobile_ValidationNo> ListOfclsMobile_ValidationNoe = appDatabase.daoMobileValidationNo().getAll();
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayNoAssign.length(); i++) {
                        ...
                        // List<clsMobile_ValidationNo> ListOfCheckclsMobile_ValidationNo = new Select()
                        // .from(clsMobile_ValidationNo.class).where(_clsMobile_ValidationNo.txtConstBitUse + "=?",
                        // txtValidationNo).execute();

                        List<clsMobile_ValidationNo> ListOfCheckclsMobile_ValidationNo = appDatabase
                                .daoMobileValidationNo().getbyConsttxtValidationNo(txtValidationNo);
...
//                                }
    ...
    private void LoadDataOutstanding() {
        //List<clsMobile_trVisitPlan_Detail> ListOfclsMobile_trVisitPlan_Details = new Select()
        // .from(clsMobile_trVisitPlan_Detail.class).execute();

        List<clsMobile_trVisitPlan_Detail> ListOfclsMobile_trVisitPlan_Details = appDatabase.daoMobileTrVisitPlanDetail().getAll();
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayVisitPlan_Header_Dummy.length(); i++) {
                        ...
                        // List<clsMobile_trVisitPlan_Header> ListOfCheckclsMobile_trVisitPlan_Header = new Select()
                        //        .from(clsMobile_trVisitPlan_Header.class)
                        //        .where(_clsMobile_trVisitPlan_Header.txtConstIntVisitPlan_HeaderID + "=?",
                        //            IntVisitPlan_HeaderID).execute();

                        List<clsMobile_trVisitPlan_Header> ListOfCheckclsMobile_trVisitPlan_Header = appDatabase
                                .daoMobileTrVisitPlanHeader().getbyVisitPlan_HeaderID(Integer.valueOf(String.valueOf(IntVisitPlan_HeaderID)));

                        clsMobile_trDeviceInfoUser _clsMobile_trDeviceInfoUser = new Mobile_tDeviceInfoUserBL()
                                .GetDeviceActive(getActivity());
...
//                                if (_clsMobile_trVisitPlan_Header.IntVisitPlan_HeaderID > 0) {
//                                    appDatabase.daoMobileTrVisitPlanHeader().update(_clsMobile_trVisitPlan_Header);
//                                } else {
//                                    appDatabase.daoMobileTrVisitPlanHeader().insert(_clsMobile_trVisitPlan_Header);
//                                }
                                appDatabase.daoMobileTrVisitPlanHeader().insert(_clsMobile_trVisitPlan_Header);
...
//                                }
                    ...
                    for (int i = 0; i < txtGetDataJsonVisitPlan_Detail_Dummy.length(); i++) {
                        ...
                        //List<clsMobile_trVisitPlan_Detail> ListOfCheckclsMobile_trVisitPlan_Detail = new Select()
                        // .from(clsMobile_trVisitPlan_Detail.class)
                        // .where(_clsMobile_trVisitPlan_Detail.txtConstintVisitPlan_DetailID + "=?", IntVisitPlan_DetailID).execute();
                        List<clsMobile_trVisitPlan_Detail> ListOfCheckclsMobile_trVisitPlan_Detail = appDatabase.daoMobileTrVisitPlanDetail()
                                .gettxtConstintVisitPlan_DetailID(IntVisitPlan_DetailID);

                        clsMobile_trDeviceInfoUser _clsMobile_trDeviceInfoUser = new Mobile_tDeviceInfoUserBL().GetDeviceActive(getActivity());
...
//                                if (UtilFunc.isStringNotNull(_clsMobile_trVisitPlan_Detail.txtGUI_Detail)) {
//                                    appDatabase.daoMobileTrVisitPlanDetail().update(_clsMobile_trVisitPlan_Detail);
//                                } else {
//                                    appDatabase.daoMobileTrVisitPlanDetail().insert(_clsMobile_trVisitPlan_Detail);
//                                }
                                appDatabase.daoMobileTrVisitPlanDetail().insert(_clsMobile_trVisitPlan_Detail);
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayCabangKNDashboard.length(); i++) {
                        ...
                        appDatabase.daoMobile_mAllbranch().insert(_clsMobile_trVisitPlan_Header);
//                        if (UtilFunc.isStringNotNull(_clsMobile_trVisitPlan_Header.IntCabangID)) {
//                            appDatabase.daoMobile_mAllbranch().update(_clsMobile_trVisitPlan_Header);
//                        } else {
//                            appDatabase.daoMobile_mAllbranch().insert(_clsMobile_trVisitPlan_Header);
//                        }
                    }
    ...
    private void LoadDataBranchKNDASHBoard() {
        ...
        List<clsMobile_mAllbranch> ListOfclsMobile_mAllbranch = appDatabase.daoMobile_mAllbranch().getAll();
    ...
    private void LoadDataBranch() {
        ...
        List<clsMobile_MBranch> ListOfclsMobile_MBranch = appDatabase.daoMobileMBranch().getAll();
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayCabang.length(); i++) {
                        ...
                        // List<clsMobile_MBranch> ListOfCheckclsMobile_MBranch = new Select().from(clsMobile_MBranch.class)
                        // .where(_clsMobile_MBranch.txtConstIntCabangID + "=?", TxtCabangID + "").execute();
                        List<clsMobile_MBranch> ListOfCheckclsMobile_MBranch = appDatabase.daoMobileMBranch()
                                .gettxtConstIntCabangID(TxtCabangID);
...
//                                if (_clsMobile_MBranch.IntCabangID > 0) {
//                                    appDatabase.daoMobileMBranch().update(_clsMobile_MBranch);
//                                } else {
//                                    appDatabase.daoMobileMBranch().insert(_clsMobile_MBranch);
//                                }
                                appDatabase.daoMobileMBranch().insert(_clsMobile_MBranch);
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                        ...
                        //List<clsMobile_mLOB> ListOfCheckclsMobile_mLOB = new Select().from(clsMobile_mLOB.class)
                        // .where(_clsMobile_mLOB.txtConstintLOBID + "=?", IntLOBID).execute();
                        List<clsMobile_mLOB> ListOfCheckclsMobile_mLOB = appDatabase.daoMobileMLOB()
                                .gettxtConstintLOBID(IntLOBID);
...
//                                if (_clsMobile_mLOB.intLOBID > 0) {
//                                    appDatabase.daoMobileMLOB().update(_clsMobile_mLOB);
//                                } else {
//                                    appDatabase.daoMobileMLOB().insert(_clsMobile_mLOB);
//                                }
                                appDatabase.daoMobileMLOB().insert(_clsMobile_mLOB);
                            } else {
...
//                                }
    ...
    private void LoadDataCategory() {
        // List<clsMobile_mVisitPlanCategory> ListOfclsMobile_mVisitPlanCategory = new Select()
        //        .from(clsMobile_mVisitPlanCategory.class).execute();
        List<clsMobile_mVisitPlanCategory> ListOfclsMobile_mVisitPlanCategory = appDatabase
                .daoMobileMVisitPlanCategory().getAll();
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayCategoryDetail.length(); i++) {
                        ...
                        // List<clsMobile_mVisitPlanCategoryDetail> ListOfCheckclsMobile_mVisitPlanCategory = new Select()
                        // .from(clsMobile_mVisitPlanCategoryDetail.class)
                        // .where(_clsMobile_mVisitPlanCategoryDetail.txtConstintCategoryIDDetail + "=?",
                        // intCategory_DetailID).execute();

                        // _clsMobile_mVisitPlanCategoryDetail.txtConstintCategoryIDDetail
                        List<clsMobile_mVisitPlanCategoryDetail> ListOfCheckclsMobile_mVisitPlanCategory = appDatabase.daoMobileMVisitPlanCategoryDetail()
                                .gettxtConstintCategoryIDDetail(intCategory_DetailID);
...
//                                if (_clsMobile_mVisitPlanCategoryDetail.intCategoryIDDetail > 0) {
//                                    appDatabase.daoMobileMVisitPlanCategoryDetail()
//                                            .update(_clsMobile_mVisitPlanCategoryDetail);
//                                } else {
//                                    appDatabase.daoMobileMVisitPlanCategoryDetail()
//                                            .insert(_clsMobile_mVisitPlanCategoryDetail);
//                                }
                                appDatabase.daoMobileMVisitPlanCategoryDetail()
                                        .insert(_clsMobile_mVisitPlanCategoryDetail);
...
//                                }
                    ...
                    for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                        ...
                        // List<clsMobile_mVisitPlanCategory> ListOfCheckclsMobile_mVisitPlanCategory = new Select()
                        //        .from(clsMobile_mVisitPlanCategory.class)
                        //        .where(_clsMobile_mVisitPlanCategory.txtConstintCategoryID + "=?",
                        //                IntCategoryID).execute();

                        List<clsMobile_mVisitPlanCategory> ListOfCheckclsMobile_mVisitPlanCategory = appDatabase
                                .daoMobileMVisitPlanCategory().getBytxtConstintCategoryID(IntCategoryID);
...
//                                if (_clsMobile_mVisitPlanCategory.intCategoryID > 0) {
//                                    appDatabase.daoMobileMVisitPlanCategory().update(_clsMobile_mVisitPlanCategory);
//                                } else {
//                                    appDatabase.daoMobileMVisitPlanCategory().insert(_clsMobile_mVisitPlanCategory);
//                                }
                                appDatabase.daoMobileMVisitPlanCategory().insert(_clsMobile_mVisitPlanCategory);
...
//                                }
    ...
    private void LoadDataPOA() {
        ...
        List<clsMobile_trPOA> ListOfclsMobile_trPOA = appDatabase.daoMobileTrPOA().getAll();
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                        ...
                        // List<clsMobile_trPOA> ListOfCheckPOA = new Select()
                        // .from(clsMobile_trPOA.class)
                        // .where(_clsMobile_trPOA.txtConstintProgramID + "=?", IntProgramID).execute();

                        List<clsMobile_trPOA> ListOfCheckPOA = appDatabase.daoMobileTrPOA()
                                .getBytxtConstintProgramID(IntProgramID);
...
//                                if (_clsMobile_trPOA.intProgramID > 0) {
//                                    appDatabase.daoMobileTrPOA().update(_clsMobile_trPOA);
//                                } else {
//                                    appDatabase.daoMobileTrPOA().insert(_clsMobile_trPOA);
//                                }
                                appDatabase.daoMobileTrPOA().insert(_clsMobile_trPOA);
...
//                                }
    ...
    private void LoadDataOutletV2() {
        // List<clsMobile_MPartnerProfile> ListOfclsMobile_MPartnerProfile = new Select()
        // .from(clsMobile_MPartnerProfile.class).execute();
        List<clsMobile_MPartnerProfile> ListOfclsMobile_MPartnerProfile = appDatabase.daoMobileMPartnerProfile().getAll();

        //List<clsMobile_MPartnerProfileAlias> ListOfclsMobile_MPartnerProfileALias = new Select()
        //        .from(clsMobile_MPartnerProfileAlias.class).execute();
        List<clsMobile_MPartnerProfileAlias> ListOfclsMobile_MPartnerProfileALias = appDatabase
                ...
                if (intresult.equals("1")) {
                    ...
                    if (txtGetDataJsonOutlet != null) {
                        ...
                        for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                            ...
                            // List<clsMobile_MPartnerProfile> ListOfCheckclsMobile_MPartnerProfile = new Select()
                            // .from(clsMobile_MPartnerProfile.class)
                            // .where(_clsMobile_MPartnerProfile.txtConstIntPartnerID + "=?", IntPartnerID).execute();
                            List<clsMobile_MPartnerProfile> ListOfCheckclsMobile_MPartnerProfile = appDatabase.daoMobileMPartnerProfile()
                                    .gettxtConstIntPartnerID(IntPartnerID);
...
//                                    if (_clsMobile_MPartnerProfile.IntPartnerID > 0) {
//                                        appDatabase.daoMobileMPartnerProfile().update(_clsMobile_MPartnerProfile);
//                                    } else {
//                                        appDatabase.daoMobileMPartnerProfile().insert(_clsMobile_MPartnerProfile);
//                                    }
                                    appDatabase.daoMobileMPartnerProfile().insert(_clsMobile_MPartnerProfile);
...
//                                    }
                    ...
                    if (txtGetDataJsonOutletAlias != null) {
                        ...
                        for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                            ...
                            Long IntPartnerID = Long.valueOf(String.valueOf(JSONObjectOutlet.get("IntPartnerID")));
                            // List<clsMobile_MPartnerProfileAlias> ListOfCheckclsMobile_MPartnerProfile = new Select()
                            // .from(clsMobile_MPartnerProfileAlias.class)
                            // .where(_clsMobile_MPartnerProfile.txtConstIntPartnerID + "=?", IntPartnerID).execute();

                            List<clsMobile_MPartnerProfileAlias> ListOfCheckclsMobile_MPartnerProfile = appDatabase
                                    .daoMobileMPartnerProfileAlias().gettxtConstIntPartnerID(IntPartnerID);
                            ...
                            if (ListOfCheckclsMobile_MPartnerProfile != null) {
                                if (ListOfCheckclsMobile_MPartnerProfile.size() == 0) {
                                    ...
                                    // _clsMobile_MPartnerProfile.save();
//                                    if (_clsMobile_MPartnerProfile.IntPartnerID > 0) {
//                                        appDatabase.daoMobileMPartnerProfileAlias().update(_clsMobile_MPartnerProfile);
//                                    } else {
//                                        appDatabase.daoMobileMPartnerProfileAlias().insert(_clsMobile_MPartnerProfile);
//                                    }
                                    appDatabase.daoMobileMPartnerProfileAlias().insert(_clsMobile_MPartnerProfile);
            ...
            try {
                ...
                if (intresult.equals("1")) {
                    ...
                    for (int i = 0; i < JSONArrayOutlet.length(); i++) {
                        ...
                        // .from(clsMobile_MPartnerProfile.class)
                        // .where(_clsMobile_MPartnerProfile.txtConstIntPartnerID + "=?", IntPartnerID).execute();
                        List<clsMobile_MPartnerProfile> ListOfCheckclsMobile_MPartnerProfile = appDatabase
                                .daoMobileMPartnerProfile().gettxtConstIntPartnerID(IntPartnerID);
        ...
        protected JSONObject doInBackground(JSONObject... params) {
            ...
            try {
                ...
                if (txtProcess.equals(_clsWarning.txtConstProcessDownloadBranch)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataCabang_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadOutlet)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataOutlet_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadBranchKNDASHBOARD)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataBranchKNDashboard_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadPOA)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataPOA_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadOutstanding)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataVisitPlanOutstanding_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadALL)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataAll_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadLOB)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataLOB_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadCategory)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataVisitPlanCategory_J", _JSONArray.toString(), getActivity());
                } else if (txtProcess.equals(_clsWarning.txtConstProcessDownloadNoRealisasi)) {
                    JsonResult = _clsMainBL.PushData("DownloadDataNORealisai_J", _JSONArray.toString(), getActivity());
                }
        ...
        protected void onPostExecute(JSONObject JsonRes) {
            if (_clsMainBL.ValidJSON(JsonRes)) {
                ...
                if (txtProcess.equals(_clsWarning.txtConstProcessDownloadBranch)) {
                    ...
                    appDatabase.daoMobileTrVisitPlanDetail().delete();
