...
public class MyServiceNative extends Service{
    ...
    private void doServiceWork() throws JSONException
    {
        ...
        List<clsMobile_mConfig> ListOfclsMobile_mConfig = new Select().from(clsMobile_mConfig.class).where("idConfig=?",8).execute();
        ...
        JSONObject JsonRes=_clsMainBL.PushDataCallPlan();
