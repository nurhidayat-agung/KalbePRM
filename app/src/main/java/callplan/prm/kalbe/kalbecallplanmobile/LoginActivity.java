...
public class LoginActivity extends clsMainAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new clsMainBL().DeleteData(LoginActivity.this);
        ...
        new Mobile_tDeviceInfoUserBL().SaveInfoDevice("", "", getApplicationContext());
        ...
        btnLogin_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etLogin_userName.getText().toString().equals("") || etLogin_pass.getText().toString().equals("")) {
                    ...
                    AsyncCallLogin _AsyncCallLogin = new AsyncCallLogin(LoginActivity.this);
    ...
    private class AsyncCallLogin extends AsyncTask<JSONObject, Void, JSONObject> {
        ...
        public AsyncCallLogin(Context context) {
        ...
        protected JSONObject doInBackground(JSONObject... params) {
            ...
            try {
                // new clsMainBL().callPushDataReturnJsonWithToken(LoginActivity.this);
                ...
                String txtNameApp = new Mobile_mConfigBL().getValue(enum_mconfig.TypeMobile.getValue(), getApplicationContext());
                ...
                List<clsMobile_mVersionApp> listOfclsMobile_mVersionApp2 = appDatabase.daoMobileMVersionApp().getAll();

                // List<clsMobile_trDeviceInfoUser> listOfclsMobile_trDeviceInfoUser = new Select()
                // .from(clsMobile_trDeviceInfoUser.class).execute();
                List<clsMobile_trDeviceInfoUser> listOfclsMobile_trDeviceInfoUser = appDatabase
                        .daoMobileTrDeviceInfoUser().getAll();
                ...
                LoginData = _clsMainBL.PushData("LogIn_J", _JSONArray.toString(), getApplicationContext());
...
//                            if (_clsMobile_UserJabatan.IntJabatanID > 0) {
//                                appDatabase.daoMobileUserJabatan().update(_clsMobile_UserJabatan);
//                            } else {
//                                appDatabase.daoMobileUserJabatan().insert(_clsMobile_UserJabatan);
//                            }
                            appDatabase.daoMobileUserJabatan().insert(_clsMobile_UserJabatan);
                        }
                        ...
                        appDatabase.daoMobileTrUserLogin().insert(_clsMobile_trUserLogin);

//                        if (_clsMobile_trUserLogin.idUserLogin > 0) {
//                            appDatabase.daoMobileTrUserLogin().update(_clsMobile_trUserLogin);
//                        } else {
//                            appDatabase.daoMobileTrUserLogin().insert(_clsMobile_trUserLogin);
//                        }

                        List<clsMobile_trUserLogin> userLogins = appDatabase.daoMobileTrUserLogin().getAll();
                        Integer userLoginsize = userLogins.size();
                        ...
                        // ListOfclsMobile_mConfig = new Select().from(clsMobile_mConfig.class)
                        // .where("idConfig=?", 5).execute();
                        ListOfclsMobile_mConfig = appDatabase.daoMobileMConfig().getbyIdConfig(5);
...
//                            }
                        ...
                        ListOfclsMobile_mConfig = appDatabase.daoMobileMConfig().getbyIdConfig(6);
...
//                            }
                        ...
                        // ListOfclsMobile_mConfig = new Select()
                        // .from(clsMobile_mConfig.class).where("idConfig=?", 9).execute();
                        ListOfclsMobile_mConfig = appDatabase.daoMobileMConfig().getbyIdConfig(9);
...
//                            }
                        ...
                        context.startService(new Intent(context, MyServiceNative.class));
                        ...
                        // new ToastCustom().showToasty(getApplicationContext(),txtWarn,2);
                    }
    ...
    private class AsyncCallVersion extends AsyncTask<JSONObject, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(JSONObject... params) {
            ...
            try {
                ...
                _JSONArray.put(JsonParam);
                roledata = _clsMainBL.PushData("CheckVersionApp_J", _JSONArray.toString(), getApplicationContext());
                /*
...
//                            if (_clsMobile_mVersionApp.idVersion > 0) {
//                                appDatabase.daoMobileMVersionApp().update(_clsMobile_mVersionApp);
//                            } else {
//                                appDatabase.daoMobileMVersionApp().insert(_clsMobile_mVersionApp);
//                            }
                            appDatabase.daoMobileMVersionApp().insert(_clsMobile_mVersionApp);
                            List<clsMobile_mVersionApp> mVersionApps = appDatabase.daoMobileMVersionApp().getAll();
                            Integer sizeApps = mVersionApps.size();
                        }
